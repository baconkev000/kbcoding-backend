...
# Web game exports (extracted from zip uploads)
GAMES_ROOT = str(APPS_DIR / "games")
GAMES_URL = "/projects/"
MAX_GAME_ZIP_SIZE = 200 * 1024 * 1024  # 200 MB
...
ADMINS = [("""Kevin Bacon""", "kevinbaconweb@gmail.com")]
